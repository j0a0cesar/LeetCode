...
const TestSpace = ({ problem }) => {
    ...
    // Filtra submissões do problema atual
    ...
    return (
        <div className='flex-1 flex flex-col h-1/2 border-t border-gray-200 bg-white'>
                                ...
                                {filteredSubmissions.length === 0 ? (
                                    ...
                                    filteredSubmissions.map((submission, index) => (
                                        <div key={submission.id} className='flex flex-col gap-1 mb-2'>
                                            <div
                                                className={`flex gap-3 p-3 rounded-lg text-sm font-medium transition-colors ${
                                            ...
                                            >
                                                ...
                                                <button 
                                                    ...
                                                    className='ml-auto text-blue-900 underline font-bold hover:text-blue-700'
                                                >
                                                    Ver Código
                                                </button>
                                            </div>
            ...
            {showModal && (
                <div className='absolute inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center p-4 z-50'>
